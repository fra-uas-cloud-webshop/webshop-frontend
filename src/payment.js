      ...
      <div className="bg-white w-4/5 mx-auto p-6 shadow-md mt-10 flex">
        ...
        <div className="w-1/3 p-4">
          ...
          <label className="block mb-4">
            ...
            />{" "}
            Express (3-4 days, tracking) - $10.00
          </label>
        ...
        <div className="w-1/3 p-4">
          ...
          <div className="border p-4 rounded-md mb-4">
            <p>
              <strong>Note Sleeve</strong>
            </p>
            <p>Color: Black</p>
            <p>Finish: Leather</p>
            <p>Qty: 1</p>
            <p>
              <strong>Price: 89.00 EUR</strong>
            </p>
          </div>
          <p>Subtotal: 89.00 EUR</p>
          <p>Shipping: 0.00 EUR</p>
          <p>
            <strong>Grand Total: 89.00 EUR</strong>
          </p>
          <button className="w-full p-3 mt-4 bg-red-500 text-white rounded-md hover:bg-red-600">
            PLACE ORDER
          </button>
        </div>
      </div>
